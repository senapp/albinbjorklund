...
const TEDxPage = () => {
    const project = projects_1.ProjectStore.get(projects_1.ProjectIdentity.TEDx);
...
exports.TEDxPage = TEDxPage;
ReactDOM.render(React.createElement(exports.TEDxPage, null), document.getElementById('root'));
//# sourceMappingURL=tedx.js.map