...
const resume_module_css_1 = require("./resume.module.css");
...
const ResumePage = () => {
    ...
    return (React.createElement(PageContainer_1.PageContainer, null,
        React.createElement(PageContent_1.PageContent, { className: resume_module_css_1.default.container },
            React.createElement("div", { className: mobileView ? resume_module_css_1.default.boxContainerMobile : resume_module_css_1.default.boxContainer },
                React.createElement("div", { className: resume_module_css_1.default.mailContainer },
                    React.createElement("h1", null, "Business"),
                    React.createElement("div", { className: resume_module_css_1.default.inputRow },
                    ...
                    React.createElement("div", { className: resume_module_css_1.default.inputRow },
                        React.createElement(TextInput_1.TextInput, { containerClassName: resume_module_css_1.default.subjectInput, label: 'Subject *', value: subject, onChange: setSubject })),
                    React.createElement("div", { className: resume_module_css_1.default.inputRow },
                        React.createElement(TextInput_1.TextInput, { containerClassName: resume_module_css_1.default.messageContainer, value: message, multiline: true, label: 'Message *', onChange: setMessage })),
                    React.createElement("div", { className: resume_module_css_1.default.mailText }, "Please do not email us about using your ad network or marketing our apps through your service."),
                    React.createElement("div", { className: resume_module_css_1.default.buttonDisplay },
                        React.createElement(Button_1.Button, { label: 'Send', className: resume_module_css_1.default.buttonStyle, onClick: () => sendEmail("business.senapp@gmail.com") }),
                        showEmail
                            ? React.createElement("a", { className: resume_module_css_1.default.link, href: "mailto:business.senapp@gmail.com" }, "business.senapp@gmail.com")
                            : React.createElement(Button_1.Button, { label: 'Show Email', className: resume_module_css_1.default.buttonStyle, onClick: () => setShowEmail(true) }))),
                React.createElement("div", { className: resume_module_css_1.default.mailContainer },
                    ...
                    React.createElement("div", { className: resume_module_css_1.default.inputRow },
                        React.createElement(TextInput_1.TextInput, { containerClassName: resume_module_css_1.default.subjectInput, label: 'Subject *', value: subjectSupport, onChange: setSubjectSupport })),
                    React.createElement("div", { className: resume_module_css_1.default.inputRow },
                        React.createElement(TextInput_1.TextInput, { containerClassName: resume_module_css_1.default.messageContainer, value: messageSupport, multiline: true, label: 'Message *', onChange: setMessageSupport })),
                    React.createElement("div", { className: resume_module_css_1.default.mailText },
                        'Please check the ',
                    ...
                    React.createElement("div", { className: resume_module_css_1.default.buttonDisplay },
                        React.createElement(Button_1.Button, { label: 'Send', className: resume_module_css_1.default.buttonStyle, onClick: () => sendEmailSupport("help.senapp@gmail.com") }),
                        showEmailSupport
                            ? React.createElement("a", { className: resume_module_css_1.default.link, href: "mailto:help.senapp@gmail.com" }, "help.senapp@gmail.com")
                            : React.createElement(Button_1.Button, { label: 'Show Email', className: resume_module_css_1.default.buttonStyle, onClick: () => setShowEmailSupport(true) })))))));
};
exports.ResumePage = ResumePage;
ReactDOM.render(React.createElement(exports.ResumePage, null), document.getElementById('root'));
