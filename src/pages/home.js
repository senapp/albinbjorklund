...
const HomePage = () => {
    return (React.createElement(PageContainer_1.PageContainer, null,
        React.createElement(PageContent_1.PageContent, { className: home_module_css_1.default.homeContainer },
            React.createElement("div", { className: home_module_css_1.default.pictureContainer },
                React.createElement("div", { className: home_module_css_1.default.backgroundShape }),
                React.createElement("img", { src: "/resources/portfolio/full_body_cropped.png", className: home_module_css_1.default.picture })),
            React.createElement("div", { className: home_module_css_1.default.introductionContainer },
